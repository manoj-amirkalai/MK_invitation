...
const ScrollRevealcode = () => {
  useEffect(() => {
    ...
    const animations = [
      ...
      { selector: "#scratchtoreveal", origin: "bottom", delay: 500 },
      { selector: "#daycount", origin: "left", delay: 750 },
      { selector: "#hourscount", origin: "bottom", delay: 1000 },
      { selector: "#mincount", origin: "bottom", delay: 1250 },
      { selector: "#seccount", origin: "right", delay: 1750 },
      { selector: "#welcometext", origin: "bottom", delay: 2000 },
      { selector: "#dayreveal", origin: "left", delay: 2250 },
      { selector: "#monthreveal", origin: "bottom", delay: 2750 },
      { selector: "#yearreveal", origin: "right", delay: 3000 },
      // location details
